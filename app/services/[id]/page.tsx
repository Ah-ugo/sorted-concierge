        ...
        const membershipData: Membership = {
          ...
          icon:
            pkg.name === "Sorted Lifestyle"
              ...
              ? Star
              : Shield,
          gradient: "from-secondary/20 via-secondary/30 to-secondary/20",
          detailedServices:
            pkg.name === "Sorted Lifestyle"
              ? [
                  {
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center text-center text-white">
        <div>
          ...
          <Link href="/services">
            <Button className="bg-secondary text-gray-900 hover:bg-secondary/80">
              Back to Memberships
            </Button>
          </Link>
        </div>
  ...
  const FloatingOrbs = () => (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      {[...Array(6)].map((_, i) => (
        <div
          key={i}
          className="absolute rounded-full bg-gradient-to-r from-secondary/10 to-secondary/5 blur-xl animate-pulse"
          style={{
            width: `${100 + i * 50}px`,
            height: `${100 + i * 50}px`,
            left: `${20 + i * 15}%`,
    ...
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-2 h-2 bg-secondary rounded-full animate-ping" />
          <div className="absolute top-40 right-32 w-1 h-1 bg-secondary rounded-full animate-pulse" />
          <div className="absolute bottom-32 left-1/4 w-3 h-3 bg-secondary rounded-full animate-bounce" />
          <div
            className="absolute top-1/3 right-20 w-2 h-2 bg-secondary rounded-full animate-ping"
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="relative mb-4 sm:mb-6">
            <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold uppercase tracking-wider bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent">
              {membership.name}
            </h1>
            <div className="absolute inset-0 text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold uppercase tracking-wider text-secondary/20 blur-2xl">
              {membership.name}
            </div>
          </div>

          {/* Subtitle with Typewriter Effect */}
          <p className="mb-4 sm:mb-6 text-secondary text-base sm:text-xl md:text-2xl italic">
            {membership.subtitle}
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-20">
            ...
            <h2 className="text-2xl sm:text-4xl md:text-6xl font-bold uppercase tracking-wider mb-4">
              What We <span className="text-secondary">Handle</span>
            </h2>
          </div>
                ...
                >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-4 sm:gap-6 flex-1">
                        ...
                        <div
                          className={`p-2 sm:p-4 rounded-xl sm:rounded-2xl transition-all duration-500 ${
                            isExpanded
                              ...
                              : "bg-gray-700/50 text-secondary group-hover:bg-secondary/20"
                          }`}
                        >
                        ...
                        <div className="flex-1">
                          <h3 className="text-lg sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-4 group-hover:text-secondary/80 transition-colors duration-300">
                            {service.title}
                          </h3>
                          <p className="text-secondary text-sm sm:text-lg mb-2 sm:mb-4 leading-relaxed">
                            {service.description}
                          </p>
                  ...
                  >
                    <div className="px-4 sm:px-8 pb-4 sm:pb-8">
                      <div className="h-px bg-gradient-to-r from-transparent via-secondary/50 to-transparent mb-4 sm:mb-6" />
                      <div className="grid gap-2 sm:gap-4">
                        {service.features.map((feature, featureIndex) => (
                          ...
                          >
                            <div className="p-0.5 sm:p-1 rounded-full bg-secondary/20 group-hover/feature:bg-secondary/30 transition-colors duration-300">
                              <CheckCircle className="w-3 h-3 sm:w-5 sm:h-5 text-secondary" />
                            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h2 className="text-2xl sm:text-4xl md:text-6xl font-bold uppercase tracking-wider mb-6 sm:mb-8">
              Ready to Experience
              <span className="block text-secondary">{membership.name}?</span>
            </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 relative z-10">
                {Object.entries(membership.contact).map(([key, value]) => {
                  ...
                  return (
                    ...
                    >
                      <div className="p-1 sm:p-2 rounded-full bg-secondary/20 group-hover:bg-secondary/30 transition-colors duration-300">
                        <IconComponent className="w-3 h-3 sm:w-5 sm:h-5 text-secondary" />
                      </div>
                      <div className="text-left">
                        <div className="text-xs sm:text-sm text-secondary font-medium uppercase tracking-wide">
                          {key}
                        </div>
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <h3 className="text-sm sm:text-xl md:text-2xl font-bold text-white pr-4 sm:pr-6 leading-tight group-hover:text-secondary/80 transition-colors duration-300">
                      {faq.question}
                    </h3>
                    <div
