...
import { servicesAPI, bookingsAPI, type Service } from "@/lib/api"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const bookingDateTime = formData.date
        ? new Date(formData.date.getFullYear(), formData.date.getMonth(), formData.date.getDate(), hours, minutes, 0)
        : new Date()
      ...
      const bookingResponse = await bookingsAPI.createBooking(bookingData, token)
      ...
      if (selectedService) {
        await airtableService.createBookingRecord(bookingResponse, selectedService, user, token)
      }

      // 3. Send notifications to admins
      await notificationService.sendBookingNotification(bookingResponse, token, {
        channels: {
          email: true,
          slack: true,
          whatsapp: true,
        },
        customMessage: `New booking for ${selectedService?.name} by ${user.firstName} ${user.lastName} on ${format(
          bookingDateTime,
          "PPP 'at' p",
        )}`,
      })
      ...
      <section className="py-20 bg-gray-50 pt-32">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <Badge className="mb-4 bg-primary/10 text-primary px-4 py-1">Book Now</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Request Our Concierge Services</h1>
            <p className="text-gray-600 text-lg mb-8">
              Complete the form below to request our services. Our team will contact you shortly to confirm your
              booking.
            </p>
          </div>
        </div>
            ...
            <div className="mb-12">
              <div className="flex justify-between items-center">
                <div className={`flex flex-col items-center ${step >= 1 ? "text-primary" : "text-gray-400"}`}>
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${step >= 1 ? "bg-primary text-white" : "bg-gray-200 text-gray-500"}`}
                  >
                    1
                  </div>
                ...
                <div className={`flex flex-col items-center ${step >= 2 ? "text-primary" : "text-gray-400"}`}>
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${step >= 2 ? "bg-primary text-white" : "bg-gray-200 text-gray-500"}`}
                  >
                    2
                  </div>
                ...
                <div className={`flex flex-col items-center ${step >= 3 ? "text-primary" : "text-gray-400"}`}>
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${step >= 3 ? "bg-primary text-white" : "bg-gray-200 text-gray-500"}`}
                  >
                    3
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="mb-4 bg-primary/10 text-primary px-4 py-1">FAQs</Badge>
              <h2 className="text-3xl font-bold mb-4">Frequently Asked Questions</h2>
              <p className="text-gray-600">Find answers to common questions about our booking process and services.</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  We recommend booking at least 24-48 hours in advance for most services. For special events or during
                  peak seasons, earlier booking is advised.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-bold text-lg mb-2">Can I modify my booking after confirmation?</h3>
                <p className="text-gray-600">
                  Yes, you can modify your booking by contacting our concierge team. Changes are subject to availability
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  We accept credit/debit cards, bank transfers, and cash payments. For most services, a deposit or full
