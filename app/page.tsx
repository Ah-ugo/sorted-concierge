          ...
          <div className="grid gap-12 md:grid-cols-2 items-center">
            ...
            >
              ...
              {/* <Button
                asChild
                variant="outline"
                className="border-secondary text-white hover:bg-secondary hover:text-muted-foreground px-8 py-4 text-xs sm:text-sm font-crimson_pro uppercase tracking-widest elegant-shadow w-fit"
              >
      ...
      {/* <section className="bg-black py-12" ref={whoWeServeRef}>
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="mb-8 text-sm sm:text-base md:text-lg font-crimson_pro text-muted-foreground">
            ...
            <p className="mb-12 text-sm sm:text-base md:text-lg font-crimson_pro text-muted-foreground">
              ...
              {isLoading ? (
                ...
                packages.map((pkg) => (
                  <Button
                    ...
                    asChild
                    variant="outline"
                    className="border-secondary text-white hover:bg-secondary hover:text-muted-foreground px-8 py-4 text-xs sm:text-sm font-crimson_pro uppercase tracking-widest elegant-shadow flex items-center"
                  >
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="mb-8 overflow-hidden relative">
                  ...
                  <div key={setIndex} className="flex gap-6">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex flex-col justify-end p-4">
                        <p className="text-[0.75rem] sm:text-xs font-crimson_pro uppercase tracking-widest text-secondary-light mb-1">
                          EVENTS
                        </p>
              ...
              <div className="absolute top-1/2 right-4 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                {/* <div className="bg-black/50 backdrop-blur-sm rounded-full p-2">
                  ...
                  <p className="text-[0.75rem] sm:text-xs text-white font-crimson_pro">
                    Drag to scroll
                  </p>
                </div> */}
              </div>
            ...
            {serviceItems.map((item, index) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <Button
                    asChild
                    className="bg-gold-gradient px-6 py-3 text-xs sm:text-sm font-crimson_pro uppercase tracking-widest text-black hover:bg-secondary-light/80 elegant-shadow opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  >
          ...
          >
            <Button
              asChild
              variant="outline"
              className="border-secondary text-white hover:bg-secondary hover:text-muted-foreground px-8 py-4 text-xs sm:text-sm font-crimson_pro uppercase tracking-widest elegant-shadow"
            >
      ...
      {/* <section className="bg-black py-12" ref={galleryRef}>
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="mb-16 text-sm sm:text-base md:text-lg font-crimson_pro text-muted-foreground">
            ...
            >
              {categories.map((category) => (
                <button
                  ...
                  className={`flex-shrink-0 px-6 py-2 text-xs sm:text-sm font-crimson_pro uppercase tracking-wider rounded-full transition-all duration-300 whitespace-nowrap ${
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 auto-rows-[200px]">
            {filteredGalleryImages.length > 0 ? (
              filteredGalleryImages.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute top-2 left-2 opacity-0 group-hover:bg-secondary-light/80 transition-opacity duration-300">
                    <span className="bg-gold-gradient text-black px-2 py-1 rounded-full text-[0.75rem] sm:text-xs font-crimson_pro uppercase tracking-wider">
                      {item.category}
                    </span>
                  </div>
                  {(index % 7 === 0 || index % 7 === 6) && (
                    <div className="absolute bottom-2 left-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      ...
                      <p className="text-white/80 text-xs sm:text-sm font-crimson_pro">
              ...
              <div className="col-span-full text-center text-muted-foreground font-crimson_pro">
          ...
          >
            <Button
              asChild
              className="bg-gold-gradient px-8 py-4 mb-5 sm:mb-0 text-xs sm:text-sm font-crimson_pro uppercase tracking-widest text-black hover:bg-secondary-light/80 mr-4 elegant-shadow"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="border-secondary px-8 py-4 text-xs sm:text-sm font-crimson_pro uppercase tracking-widest text-secondary hover:bg-secondary hover:text-muted-foreground hover:border-secondary elegant-shadow"
            >
              <Link href="/contact">Request Private Access</Link>
            </Button>
          </motion.div>
